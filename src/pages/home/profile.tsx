      ...
      <section>
        <div className="border-b-2 border-whiteGray pb-10">
          ...
          <div className="flex justify-center  items-center flex-col">
            ...
            <span className="text-white mt-2 text-2xl font-bold">Erwin Aghajani</span>
          </div>
          <div className="flex justify-center">
          <p className="text-low-color-accent mt-4 "><FontAwesomeIcon icon={faCalendarAlt} className="mr-2"></FontAwesomeIcon>Joined since july 2023</p>
