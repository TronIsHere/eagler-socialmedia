...
function App() {
  return (
    ...
    <div className="grid grid-cols-5 w-full">
      <div className="bg-secondary border-r-2 border-whiteGray h-screen">
      <div className="w-full bg-primary h-14 flex">
      <img src="eagleLogo.png" alt="" className='object-fill logoContainer pl-10'/>
      </div>
        <MainMenu></MainMenu>
      </div>
      <div className="bg-secondary border-r-2 border-whiteGray h-screen col-span-3">
      ...
      <div className="bg-secondary border-whiteGray h-screen"></div>
    </div>
    </>
  )
}
